      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div>
            ...
            <h3 className="text-4xl md:text-5xl font-serif font-bold text-primary-900 mb-4">What Client Say about Vintage</h3>
            <p className="text-slate-500 text-lg max-w-xl">From strategic tax planning and full-cycle accounting to seamless payroll and compliance, discover how we empower our clients to achieve financial peace of mind.</p>
          </div>
